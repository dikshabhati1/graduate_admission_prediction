...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output<0:
            return render_template('index.html',prediction_texts="Sorry you cannot take admission")
        else:
            return render_template('index.html',prediction_text="Youe Admission probability is {}".format(output))
    else:
        return render_template('index.html')
